...
export const DuesBillTemplate: React.FC<DuesBillTemplateProps> = ({ student, school, classFee, selectedMonthIndex }) => {
    ...
    for (let i = 0; i <= selectedMonthIndex; i++) {
        ...
        feeRecords.push(
            <tr key={monthKey} style={styles.tableRow}>
        ...
        <div style={styles.bill}>
            <div style={styles.header}>
                ...
                <div style={styles.billTitle}>
                    ...
                    <p style={styles.billDate}>Date: {new Date().toLocaleDateString()}</p>
                </div>
            </div>
...
const styles: { [key: string]: React.CSSProperties } = {
    ...
    schoolInfo: { flexGrow: 1 },
    schoolName: { fontSize: '14pt', fontWeight: 'bold', margin: 0, color: '#111827' },
    schoolAddress: { fontSize: '8pt', margin: '2px 0 0 0', color: '#4b5563' },
    billTitle: { textAlign: 'right' },
    ...
    detailItem: { margin: 0, padding: '1px 0', fontSize: '9pt' },
    ...
    tableHeader: { padding: '5px', borderBottom: '1px solid #d1d5db', textAlign: 'left' },
    tableBody: {},
    tableRow: {},
    tableCell: { padding: '5px', borderBottom: '1px dotted #e5e7eb' },
    textRight: { textAlign: 'right' },
    textCenter: { textAlign: 'center' },
    statusBadge: { padding: '2px 6px', borderRadius: '10px', fontSize: '8pt', fontWeight: '500' },
...
export default DuesBillTemplate;